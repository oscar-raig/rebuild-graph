...
BOOST_AUTO_TEST_CASE( UTest_gslGraph_compare_bad_parameter_1){
...
BOOST_AUTO_TEST_CASE(UTest_gslGraph_compare_bad_parameter_2){
...
BOOST_AUTO_TEST_CASE(UTest_gslGraph_compare_different_graphs) {
...
BOOST_AUTO_TEST_CASE(UTest_gslGraph_compare_equal_graphs) {
